...
class AtendimentoIn(BaseModel):
    ...
    origem_endereco: Optional[OrigemEnderecoCod] = Field(default=OrigemEnderecoCod.LOGIN, description="Origem de endereço.")
    tipo: Optional[TipoCod] = Field(default=TipoCod.CLIENTE, description="Tipo do atendimento.")
    titulo: str = Field(description="Título do atendimento.")
    prioridade: Optional[PrioridadeCod] = Field(default=PrioridadeCod.NORMAL, description="Pioridade do atendimento.")
    su_status: Optional[SuStatusCod] = Field(default=SuStatusCod.NOVO, description="Status do atendimento.")
