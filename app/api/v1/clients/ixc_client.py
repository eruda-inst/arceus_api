...
class IXCCliente:
    ...
    def _get_headers(self, include_ixcsoft: bool = True) -> Any:
    ...
    async def get_valor_e_data_vencimento(self, id_contrato: int) -> Any:
        grid_param = [
    ...
    async def get_id_cliente_ixc(self, cnpj_cpf: str) -> Any:
